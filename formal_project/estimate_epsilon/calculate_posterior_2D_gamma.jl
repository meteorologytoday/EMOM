...
γ_vec = range(0.00, 0.1, length=Nγ)
...
output_file = "eps_gamma_logpost2D_$(scheme).nc"
...
Dataset(output_file, "c") do ds
    ...
    defDim(ds, "Ngamma", Nγ)
    for (varname, vardata, vardim, attrib) in [
        ("logpost_w",  logpost_w,  ("Neps", "Ngamma",), Dict()),
        ("post_w",     post_w,     ("Neps", "Ngamma"), Dict()),
        ("logpost_u",  logpost_u,  ("Neps", "Ngamma",), Dict()),
        ("post_u",     post_u,     ("Neps", "Ngamma"), Dict()),
        ("logpost_uw", logpost_uw, ("Neps", "Ngamma",), Dict()),
        ("post_uw",    post_uw,    ("Neps", "Ngamma"), Dict()),
        ("epsilon",        ϵ_vec,    ("Neps",), Dict()),
        ("gamma",  γ_vec,    ("Ngamma",), Dict()),
    ]
