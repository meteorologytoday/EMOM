...
const S_ref = 34.7 # PSU  ocean reference salinity used to compute virtual salt flux. This value is copied from models/csm_share/shr/shr_const_mod.F90 (SHR_CONST_OCN_REF_SAL)
